...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="<?=base_url();?>site/css/images/favicon.ico" />
	<link rel="stylesheet" href="<?=base_url();?>site/css/style.css" type="text/css" media="all" />
	<link rel="stylesheet" href="<?=base_url();?>site/css/flexslider.css" type="text/css" media="all" />
	<link href='//fonts.googleapis.com/css?family=Ubuntu:400,500,700' rel='stylesheet' type='text/css' />
	
	<script src="<?=base_url();?>site/js/jquery-1.8.0.min.js" type="text/javascript"></script>
	<!--[if lt IE 9]>
		<script src="js/modernizr.custom.js"></script>
	<![endif]-->
	<script src="<?=base_url();?>site/js/jquery.flexslider-min.js" type="text/javascript"></script>
	<script src="<?=base_url();?>site/js/functions.js" type="text/javascript"></script>
</head>
<body>
	<div id="wrapper">
						...
						<div class="header-inner">
							...
							<div class="slider-holder">
								<div class="flexslider">
									<ul class="slides">
										<li><img src="<?=base_url();?>site/css/images/slide-img.png" alt="" /></li>
				...
				<div class="shell">
					<div class="container">
						...
						<section class="blog">
							<!-- content -->
							<div class="content">
								<img src="<?=base_url();?>site/css/images/i-img.png" alt=""  class="alignleft"/>
								<div class="cnt">
								...
								<div class="widget">
									...
									<ul>
										...
										<li class="<?=$data[$i]['Status'];?>">
											...
											<p><a href="#"><?=$data[$i]['DeviceID'];?> - <?=$data[$i]['DeviceLabel'];?><em class="mobile"> </em><span><?=$data[$i]['ReportedOn'];?></span></a> </p>
										</li>
										<?php }?>
						...
						<section class="cols">
							<div class="col">
								...
								<img src="<?=base_url();?>site/css/images/cols-img.png" alt="" class="alignleft"/>
								<div class="col-cnt">
							...
							<div class="col">
								<h3>We’re Hiring</h3>
								<img src="<?=base_url();?>site/css/images/cols-img2.png" alt="" class="alignleft"/>
								<div class="col-cnt">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras molestie condimentum conse am leo libero, samet dor.</p>
								</div>
								<a href="#" class="view">View More</a>
							...
							<div class="col">
								<h3>Our Partners</h3>
								<img src="<?=base_url();?>site/css/images/cols-img3.png" alt="" class="alignleft"/>
								<div class="col-cnt">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras molestie condimentum conse am leo libero, samet dor.</p>
								</div>
								<a href="#" class="view">View More</a>
	...
	<div  id="footer">
		...
		<div class="footer-bottom">
			<div class="shell">
				...
				<p class="copy">&copy; Copyright 2017<span>|</span>Sitename. Design by <a href="http://healthdevice.com" target="_blank">healthdevice.com</a></p>
			</div>
		</div>
	</div>
	<!-- end of footer -->
